...
| [Szegedy C, Ioffe S, Vanhoucke V, et al. Inception-v4, inception-resnet and the impact of residual connections on learning[C]//Proceedings of the AAAI conference on artificial intelligence. 2017, 31(1).](https://ojs.aaai.org/index.php/aaai/article/view/11231) | Google Inc. | [Code]([https://github.com/shanglianlm0525/PyTorch-Networks/blob/master/ClassicNetwork/InceptionV4.py](https://github.com/weiaicunzai/pytorch-cifar100/blob/master/models/inceptionv4.py)) |
